...
public class PlayerController : MonoBehaviour
{
    ...
    public float maxSpeed = 5.6f;          // Velocidad m�xima
    public float acceleration = 0.05f;     // Aceleraci�n por nivel o distancia
    ...
    public float maxHoldTime = 0.22f;      // Tiempo m�ximo de salto prolongado
    public float coyoteTime = 0.10f;       // Tiempo de gracia despu�s de dejar el suelo
    ...
    void Update()
    {
        // Auto-run con aceleraci�n progresiva
